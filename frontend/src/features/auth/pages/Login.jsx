            ...
            <section className="w-full max-w-md rounded-2xl border border-[#e4e7ec] bg-[#f5f6f7] p-6 shadow-[0_20px_55px_rgba(17,20,23,0.08)] dark:border-[#3a4048] dark:bg-[#2a2e34] dark:shadow-[0_20px_55px_rgba(0,0,0,0.2)] sm:p-9">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input id="email" type="email" placeholder="Enter your email address" value={email} className="w-full rounded-lg border border-[#d0d5dd] bg-white px-4 py-3 text-sm outline-none transition focus:border-[#ff6a00] focus:ring-2 focus:ring-[#ff6a00]/20 dark:border-[#515861] dark:bg-[#111417] dark:placeholder:text-[#a1a6ad]" onChange={(e)=>{setEmail(e.target.value)}}/>
                    </div> 
                    <div>
                        <label htmlFor="password" className="mb-2 block text-sm font-medium">Password</label>
                        <input id="password" type="password" placeholder="Enter your password" value={password} className="w-full rounded-lg border border-[#d0d5dd] bg-white px-4 py-3 text-sm outline-none transition focus:border-[#ff6a00] focus:ring-2 focus:ring-[#ff6a00]/20 dark:border-[#515861] dark:bg-[#111417] dark:placeholder:text-[#a1a6ad]" onChange={(e)=>{setPassword(e.target.value)}}/>
                    </div>
